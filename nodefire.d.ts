...
declare class NodeFire {
     ...
     */
    static interceptOperations(callback: Function): void;
    /**
     ...
     */
    transaction(updateFunction: (arg0: any) => any, options: any): Promise<any>;
    /**
...
declare namespace NodeFire {
    const LOG_TRANSACTIONS: boolean;
}
